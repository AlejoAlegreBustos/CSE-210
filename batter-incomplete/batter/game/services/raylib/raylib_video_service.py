...
class RaylibVideoService(VideoService):
    ...
    def draw_image(self, image, position):
        ...
        #arreglar problema path hay que usar el codigo de yani
        # fixed os dependent filepath
        filepath = pathlib.Path(filepath)
        texture = self._textures[r"C:\Users\Alejo Alegre Bustos\Desktop\BYU\CSE-210\batter-incomplete\batter\assets\images\000.png"]
        x = position.get_x()
        y = position.get_y()
    ...
    def draw_text(self, text, position):
        ...
        # fixed os dependent filepath pathlib.Path(filepath).absolute()
        ...
        font = self._fonts[r"C:\Users\Alejo Alegre Bustos\Desktop\BYU\CSE-210\batter-incomplete\batter\assets\fonts\zorque.otf"]
